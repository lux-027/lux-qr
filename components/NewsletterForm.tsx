...
export default function NewsletterForm() {
  ...
  if (success) {
    return (
      <div className="bg-gray-50 backdrop-blur-sm border border-gray-200 rounded-2xl p-4 md:p-8">
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-2 md:gap-3">
          <input
            ...
            className="flex-1 px-3 md:px-4 py-2 md:py-3 rounded-xl bg-white/80 border border-gray-200 text-gray-900 placeholder-gray-400 focus:border-blue-500/50 focus:outline-none text-sm md:text-base"
            required
          />
          <button
            type="submit"
            disabled={loading}
            className="px-4 md:px-6 py-2 md:py-3 bg-blue-600 hover:bg-blue-700 text-gray-900 font-semibold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base"
          >
