  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-6 left-4 z-50 p-3 rounded-2xl bg-slate-800/50 text-blue-500 hover:text-blue-400 hover:bg-slate-700/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.5)] transition-all duration-300 border border-white/10"
      >
