...
import { Share2, Instagram, Facebook, Youtube, Clock, Shield, Zap, Video, FileText, Music } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="relative inline-block">
            ...
            <div className="relative flex items-center justify-center gap-3 mb-4">
              <Share2 className="w-10 h-10 md:w-12 md:h-14 text-blue-400 drop-shadow-[0_0_15px_rgba(59,130,246,0.6)]" />
        ...
        >
          ...
          >
            ...
            <p className="text-gray-400 text-sm">Instagram hesabınız için QR kod</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-400 text-sm">TikTok hesabınız için QR kod</p>
          </div>
          ...
          >
            <Facebook className="w-12 h-12 text-blue-400 mb-4" />
            <h3 className="text-xl font-semibold text-white mb-2">Facebook</h3>
            <p className="text-gray-400 text-sm">Facebook hesabınız için QR kod</p>
          </div>
          ...
          >
            <Youtube className="w-12 h-12 text-blue-400 mb-4" />
            <h3 className="text-xl font-semibold text-white mb-2">YouTube</h3>
            <p className="text-gray-400 text-sm">YouTube kanalınız için QR kod</p>
          </div>
        </motion.div>
        ...
        >
          <div>
            <label className="flex items-center gap-2 text-white font-semibold mb-2">
              {selectedPlatform === 'instagram' && <Instagram className="w-5 h-5 text-blue-400" />}
              {selectedPlatform === 'tiktok' && <Music className="w-5 h-5 text-blue-400" />}
              {selectedPlatform === 'facebook' && <Facebook className="w-5 h-5 text-blue-400" />}
              {selectedPlatform === 'youtube' && <Youtube className="w-5 h-5 text-blue-400" />}
        ...
        >
          <div className="card-premium p-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Hızlı Erişim</h3>
          ...
          <div className="card-premium p-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Çoklu Platform</h3>
            <p className="text-gray-400 text-sm">
        ...
        >
          <div className="card-premium p-6">
            <h3 className="text-lg font-semibold text-white mb-3 text-gradient">Link-in-Bio Nedir?</h3>
          ...
          <div className="card-premium p-6">
            <h3 className="text-lg font-semibold text-white mb-3 text-gradient">Sosyal Medya Pazarlaması</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
        ...
        >
          <h2 className="text-2xl font-bold text-white mb-4 text-gradient">Link-in-Bio Çözümlerinin Marka Değerine Etkisi</h2>
          ...
          <h3 className="text-xl font-semibold text-white mb-3">Marka Değerine Katkıları</h3>
          <p className="text-gray-400 mb-6">
